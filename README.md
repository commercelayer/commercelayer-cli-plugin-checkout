...
_See code: [src/commands/checkout/index.ts](https://github.com/commercelayer/commercelayer-cli-plugin-checkout/blob/v1.0.0/src/commands/checkout/index.ts)_
...
_See code: [src/commands/checkout/order.ts](https://github.com/commercelayer/commercelayer-cli-plugin-checkout/blob/v1.0.0/src/commands/checkout/order.ts)_
<!-- commandsstop -->
